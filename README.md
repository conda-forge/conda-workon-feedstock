About conda-workon-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/conda-workon-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5521&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/conda-workon-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `conda-workon` can be installed with `conda`:
...
```
mamba install conda-workon
```

It is possible to list all of the versions of `conda-workon` available on your platform with `conda`:
...
```
mamba search conda-workon --channel conda-forge
```
...
mamba repoquery search conda-workon --channel conda-forge

# List packages depending on `conda-workon`:
mamba repoquery whoneeds conda-workon --channel conda-forge

# List dependencies of `conda-workon`:
mamba repoquery depends conda-workon --channel conda-forge
```
